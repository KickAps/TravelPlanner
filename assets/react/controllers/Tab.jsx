    ...
    render() {
        return (
            <ul className="text-5xl font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
                <li className="w-full">
                    <button type="button" onClick={this.showSteps} className="inline-block w-full p-4 bg-white text-blue-400 focus:ring-2 focus:ring-blue-300 focus:outline-none">Étapes</button>
                </li>
                <li className="w-full">
                    <button type="button" onClick={this.showMap} className="inline-block w-full p-4 bg-white text-blue-400 focus:ring-2 focus:ring-blue-300 focus:outline-none">Carte</button>
                </li>
            </ul>
